...
public class LawActivity4 extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_law4);

        Toolbar toolbar = findViewById(R.id.toolbar_duongcam);
        setSupportActionBar(toolbar);

        drawerLayout = findViewById(R.id.drawer_layout_duongcam);
        NavigationView navigationView = findViewById(R.id.nav_view_duongcam);
        ...
        recyclerViewLuat = findViewById(R.id.recyclerView_duongcam);
    ...
    private void loadItemsFromJson() {
        try {
            ...
            JSONArray jsonArray = jsonObj.getJSONArray("duongcam");
