...
import com.example.drivingtestapp.services.ApiService1;
...
public class ExamActivity1 extends AppCompatActivity {
    ...
    private void getQuestions() {
        ApiService1.apiService.questionCall().enqueue(new Callback<List<Question>>() {
            @Override
            public void onResponse(Call<List<Question>> call, Response<List<Question>> response) {
                ...
                ViewPagerAdapter adapter = new ViewPagerAdapter(ExamActivity1.this, questions);
            ...
            public void onFailure(Call<List<Question>> call, Throwable t) {
                Toast.makeText(ExamActivity1.this, "Error: " + t.getMessage(), Toast.LENGTH_SHORT).show();
        ...
        new AlertDialog.Builder(this)
                ...
                .setPositiveButton(android.R.string.ok, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        Intent intent = new Intent(ExamActivity1.this, ExamListActivity.class);
